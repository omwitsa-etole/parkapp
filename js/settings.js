							...
							<div class="pt-3">
							  <div class="d-flex flex-row pb-3">
								<div class="rounded border border-primary border-2 d-flex w-100 p-3 align-items-center"
								  ...
								  <div class="d-flex flex-column">Current Rate</p>
									<h6 class="mb-0 text-primary">KES 45</h6>
								  </div>
								</div>
							  </div>
							  ...
							  <div class="d-flex flex-row pb-3">
								<div class="rounded border border-primary border-2 d-flex w-100 p-3 align-items-center"
								  ...
								  <div class="d-flex flex-column">
									...
									<h6 class="mb-0 text-primary">KES</h6>
...
function newRate(){
	...
	el.innerHTML = `
		...
		<div class="modalbox">
			<a style='position:absolute;right:1%;top:1%;color:#FF7474;cursor:pointer;' onclick="document.getElementById(${id}).remove()">Cancel</a>
		  <form class="form">
			<div class="banner"></div>
			<label class="title">Add New customers rates</label>
			<p class="description">Grow your customer base with yourrates, you can reach a much bigger and better fan community. </p>
			<div class="tab-container">
			  <button class="tab tab--1" >Hourly</button>
			  <button class="tab tab--2 selected">Flat</button>
			  <button class="tab tab--3">Extension</button>
			  
			</div>

			<div class="benefits">
			  <span>What will be offered</span>
			  <ul>
				<li>
				  ...
				  <span>An hourly rate of KES <input type="number" min="1" value="1" onchange="document.getElementById('ratevalue').innerText=this.value"/></span>
				</li>
			...
			<div class="modal--footer">
			  <label class="price"><sup>KES</sup><b id="ratevalue">5</b><sub >/<span id="ratetype">flat</span></sub></label>
			  <button class="upgrade-btn" onclick="document.getElementById(${id}).remove()">Activate Selected</button>
			</div>
		  </form>
		</div>
	`
	...
	body.appendChild(el)
	const al = document.getElementsByClassName("tab")
	...
	for(const btn of al){
		btn.addEventListener("click",()=>{
			...
			document.getElementById("ratetype").innerText = btn.innerText.toLowerCase()
		})
				...
				<div class="modalbox">
					...
					<rect fill="white" height="38.1" width="80"></rect>
					  ...
					  <div class="credit-card-info--form">
						...
						<button class="purchase--btn">Submit</button>
